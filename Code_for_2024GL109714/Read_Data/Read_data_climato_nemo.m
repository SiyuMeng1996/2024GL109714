...
function [outputArg1] = Read_data_climato_nemo(Curr,Para_name,Para_in_Data,dimention,start_date,end_date)
...
%% 准备读取数据
Para_name    = Para_name;
Para_in_Data = Para_in_Data;
dimention    = dimention;
start_date   = start_date;
end_date     = end_date;

File = dir(fullfile(Curr,['nemo*',dimention,'.nc']));  
FileNames = {File.name}';   
Data_mid=[];
